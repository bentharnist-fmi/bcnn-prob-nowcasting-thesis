...
\begin{figure}[H]
	\centering
	\subfloat[$\sigma_\ell=10^{-2}$]{\includegraphics[width=0.45\linewidth]{images/model_choice/sigma_e-2}}
	\subfloat[$\sigma_\ell=10^{-3}$]{\includegraphics[width=0.45\linewidth]{images/model_choice/sigma_e-3}}
	
	\subfloat[$\sigma_\ell=10^{-4}$]{\includegraphics[width=0.45\linewidth]{images/model_choice/sigma_e-4}}
...
\begin{figure}[H]
	...
	\caption{The relation of KL-weighting scheme to the parameter posterior distributions across the network. $\mu_q$ histograms describe the parameter mean distributions, whereas $\sigma_q$ distributions describe the distribution of their standard deviations. The prior chosen is prior (4). The black dashed vertical lines indicate the initialization value for standard deviations.}
