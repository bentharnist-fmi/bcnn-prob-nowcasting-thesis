...
\begin{figure}[H]
	\centering
	\subfloat[$\sigma=1e^{-2}$]{\includegraphics[width=0.33\linewidth]{images/model_choice/sigma_e-2}}
	\subfloat[$\sigma=1e^{-3}$]{\includegraphics[width=0.33\linewidth]{images/model_choice/sigma_e-3}}
	\subfloat[$\sigma=1e^{-4}$]{\includegraphics[width=0.33\linewidth]{images/model_choice/sigma_e-4}}
...
\begin{figure}[H]
	\centering
	\subfloat[Equal]{\includegraphics[width=0.5\linewidth]{images/weight/bcnn_t2_gsm_small_diff_lt5}}
	\subfloat[Blundell]{\includegraphics[width=0.5\linewidth]{images/weight/bcnn_t2_gsm_small_diff_blundell_lt5}}
	\subfloat[Epoch]{\includegraphics[width=0.5\linewidth]{images/weight/bcnn_t2_gsm_small_diff_epoch_lt5}}
