...
\newcommand{\FDATE}{29. heinäkuuta 2022}
...
\newcommand{\SUPERVISOR}{Prof. Arno Solin}
\newcommand{\FSUPERVISOR}{Prof. Arno Solin}
%\newcommand{\SSUPERVISOR}{Professor Antti Ylä-Jääski\\
...
\newcommand{\FINSTRUCTOR}{FT Terhi Mäkinen, \\
	 FT Seppo Pulkkinen}
%\newcommand{\FINSTRUCTOR}{Diplomi-insinööri Oili Ohjaaja\\
