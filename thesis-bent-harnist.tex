...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Probabilistic Precipitation Nowcasting with Bayesian Convolutional Neural Networks}
...
\newcommand{\INSTRUCTOR}{Terhi Mäkinen D.Sc. (Tech.)\\
Seppo Pulkkinen D.Sc.}
\newcommand{\FINSTRUCTOR}{Terhi Mäkinen D.Sc. (Tech.)\\
	Seppo Pulkkinen D.Sc.}
%\newcommand{\FINSTRUCTOR}{Diplomi-insinööri Oili Ohjaaja\\
